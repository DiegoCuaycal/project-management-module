        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('entrevistas.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <div class="ms-auto text-muted">
                                    <form action="{{ route('entrevistas.index') }}" method="GET">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="Buscar entrevista"
                                                name="search">
                                    ...
                                    @forelse ($entrevistas as $entrevista)
                                        <tr>
                                            <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                    aria-label="Select entrevista"></td>
                                            <td>{{ ++$i }}</td>
                                            <td>
                                                <textarea class="form-control" rows="5" readonly style="width: 100%; white-space: pre-wrap;">{{ trim($entrevista->registroDatos) }}</textarea>
                                            </td>
                        ...
                        <div class="card-footer d-flex align-items-center">
                            {!! $entrevistas->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
