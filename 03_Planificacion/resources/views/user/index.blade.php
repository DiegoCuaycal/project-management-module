                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nombre</th>
                                        <th>Correo</th>
                                        <th>Rol</th> <!-- Nueva columna para los roles -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($user->roles as $role)
                                                    {{ $role->nombre }} <!-- Cambiado de $role->name a $role->nombre -->
                                                    @if (!$loop->last)
                                                        , <!-- Muestra una coma entre los nombres de los roles, excepto para el último -->
                                                    @endif
                                                @endforeach
                                            </td> <!-- Muestra los roles del usuario -->
